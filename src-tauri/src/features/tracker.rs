...
use tauri::Manager;
use windows::{
    Win32::Foundation::*, Win32::System::ProcessStatus::*, Win32::System::Threading::*,
...
pub fn run_tracker_loop(app_handle: tauri::AppHandle, stop: Arc<AtomicBool>) {
    ...
    loop {
        ...
        let current_activity = match get_active_window_info_internal() {
            Ok(info) => Some(info),
            Err(_) => None,
        };
