...
#[tauri::command]
fn scan_dictionary_directory(directory: String) -> Result<Vec<DictionarySource>, String> {
...
#[tauri::command]
fn lookup_word(word: String, dictionary_file: Option<String>) -> Result<String, String> {
        ...
        .filter(|value| !value.is_empty())
    {
        ...
        // TODO: 在这里接入真实的 MDX / MDD 词典索引、检索与 HTML 渲染流程。
